...
viz_lm <- 
  function(yr){
    log_gdp <- log(gapminder[["gdpPercap"]][gapminder$year == yr])
log_le <- log(gapminder[["lifeExp"]][gapminder$year == yr])
fit <- lm(log_le ~ log_gdp)
plot(log_le ~ log_gdp, main= yr,xlab="gdpPercapita",ylab="lifeExp")
lines(log_gdp,predict(fit),col='blue')
  }
...
viz_lm <- 
  function(cont){
    log_gdp <- log(gapminder[["gdpPercap"]][gapminder$continent == cont])
log_le <- log(gapminder[["lifeExp"]][gapminder$continent == cont])
fit <- lm(log_le ~ log_gdp)
plot(log_le ~ log_gdp, main= cont,xlab="gdpPercapita",ylab="lifeExp")
lines(log_gdp,predict(fit),col='blue')
  }
